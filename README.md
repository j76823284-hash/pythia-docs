---
description: A decentralized truth machine for WAX and Antelope.
---
...
* Browse the **[Contract Reference](resources/contract-reference/README.md)** for every action, table, and memo convention.
